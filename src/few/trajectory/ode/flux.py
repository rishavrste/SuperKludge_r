...
class SuperKludgeFlux(KerrEccEqFlux):
    ...
    Additional parameters (in this order):
        ...
        evolve_primary (bool) : whether to evolve MBH mass M and spin Chi1
        evolve_2PA (bool) : whether to include 2PA terms
    """
    ...
    def add_fixed_parameters(self, m1: float, m2: float, a: float, additional_args = None):
        ...
        try:
            self.evolve_primary = bool(additional_args[1]) #whether to evolve \delta~M, \delta~a. If False, just set delta_m1, delta_a = 0.0 throughout evolution.
        ...
        try:
            self.evolve_2PA = bool(additional_args[2]) #whether to include 2PA corrections
        except IndexError:
    ...
    def modify_rhs(
        ...
        #print(pdot, pdot1PA, pdot2PA)
        #print(edot, edot1PA, edot2PA)
