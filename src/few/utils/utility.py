    ...
    **kwargs,
    ...
    while bounds[0] < bounds[1]:
        try:
            ...
            if len(traj_args) > 5:
                traj_pars = traj_pars + traj_args[5:] #SuperKludge Modification

            t, p, e, xI, Phi_phi, Phi_theta, Phi_r = traj_module(*traj_pars, T=t_out*1.001)[:7] #SuperKludge Modification
